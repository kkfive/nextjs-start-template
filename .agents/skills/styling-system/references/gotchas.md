...
- Tailwind preflight 与 antd 默认样式可能冲突 → 从 Tailwind v4 入口 `apps/client/src/styles/tailwind.css` 调整 CSS layer / source 范围，共享 PostCSS 能力统一由 `internal/tailwind-config` 提供
