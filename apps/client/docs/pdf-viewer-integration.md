...
- **组件位置**: `src/components/common/pdf-viewer/`
...
const PdfViewer = dynamic(
  () => import('@/components/common/pdf-viewer').then(mod => ({ default: mod.PdfViewer })),
  {
    ssr: false,
...
Worker 文件版本必须与 `pdfjs-dist` 版本匹配。当前锁定版本：
...
```tsx
// 在 src/components/common/pdf-viewer/index.tsx 中修改
<Page
