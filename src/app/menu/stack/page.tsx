  ...
  return (
    <div className="relative box-border h-full">
      <div className="relative z-1">
        <div className="mt-2 box-border w-full overflow-hidden px-4 break-all">
...
function BackgroundCircle() {
  return (
    <div className="fixed top-0 right-0 bottom-auto left-auto size-[500px] translate-x-[-30%] translate-y-[20%] rounded-full bg-[rgba(173,109,244,0.5)] opacity-50 blur-[80px]">
    </div>
  )
}
